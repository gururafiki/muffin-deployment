...
\i stack/supabase/migrations-legacy/082-macro-is-a-catalogue-not-a-hardcoded-list.sql
\i stack/supabase/migrations-legacy/083-fred-fills-the-gap-econdb-left.sql
...
\i stack/supabase/migrations-legacy/085-a-series-that-returns-rows-can-still-be-a-year-stale.sql
