...
begin
  ...
  -- 3. THE CURSOR IS A QUARTER, NOT A WEEK. A month later it must still be current: re-asking
  ...
  -- 4. AND IT DOES EXPIRE. A quarter later there is a new filing to collect.
